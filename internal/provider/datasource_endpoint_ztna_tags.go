...
type datasourceEndpointZtnaTagsModel struct {
...
func (r *datasourceEndpointZtnaTags) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var data datasourceEndpointZtnaTagsModel
...
func (m *datasourceEndpointZtnaTagsModel) refreshEndpointZtnaTags(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceEndpointZtnaTagsModel) getURLObjectEndpointZtnaTags(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

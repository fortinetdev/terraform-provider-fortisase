...
type datasourceDemCustomSaasAppsModel struct {
...
func (r *datasourceDemCustomSaasApps) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var data datasourceDemCustomSaasAppsModel
...
func (m *datasourceDemCustomSaasAppsModel) refreshDemCustomSaasApps(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceDemCustomSaasAppsModel) getURLObjectDemCustomSaasApps(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

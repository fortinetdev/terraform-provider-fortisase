...
var _ datasource.DataSource = &datasourceNetworkImplicitDnsRule{}

func newDatasourceNetworkImplicitDnsRule() datasource.DataSource {
	return &datasourceNetworkImplicitDnsRule{}
}

type datasourceNetworkImplicitDnsRule struct {
	fortiClient  *FortiClient
	resourceName string
}

// datasourceNetworkImplicitDnsRuleModel describes the datasource data model.
type datasourceNetworkImplicitDnsRuleModel struct {
...
func (r *datasourceNetworkImplicitDnsRule) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_network_implicit_dns_rule"
}

func (r *datasourceNetworkImplicitDnsRule) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *datasourceNetworkImplicitDnsRule) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *datasourceNetworkImplicitDnsRule) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceNetworkImplicitDnsRuleModel
...
func (m *datasourceNetworkImplicitDnsRuleModel) refreshNetworkImplicitDnsRule(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceNetworkImplicitDnsRuleModel) getURLObjectNetworkImplicitDnsRule(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

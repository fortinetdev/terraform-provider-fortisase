...
var _ datasource.DataSource = &datasourceSecurityDlpFingerprintDatabase{}

func newDatasourceSecurityDlpFingerprintDatabase() datasource.DataSource {
	return &datasourceSecurityDlpFingerprintDatabase{}
}

type datasourceSecurityDlpFingerprintDatabase struct {
	fortiClient  *FortiClient
	resourceName string
}

// datasourceSecurityDlpFingerprintDatabaseModel describes the datasource data model.
type datasourceSecurityDlpFingerprintDatabaseModel struct {
	...
	Schedule                      *datasourceSecurityDlpFingerprintDatabaseScheduleModel       `tfsdk:"schedule"`
	...
	Authentication                *datasourceSecurityDlpFingerprintDatabaseAuthenticationModel `tfsdk:"authentication"`
}

func (r *datasourceSecurityDlpFingerprintDatabase) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_security_dlp_fingerprint_database"
}

func (r *datasourceSecurityDlpFingerprintDatabase) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *datasourceSecurityDlpFingerprintDatabase) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *datasourceSecurityDlpFingerprintDatabase) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceSecurityDlpFingerprintDatabaseModel
...
func (m *datasourceSecurityDlpFingerprintDatabaseModel) refreshSecurityDlpFingerprintDatabase(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceSecurityDlpFingerprintDatabaseModel) getURLObjectSecurityDlpFingerprintDatabase(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {
...
type datasourceSecurityDlpFingerprintDatabaseScheduleModel struct {
...
type datasourceSecurityDlpFingerprintDatabaseAuthenticationModel struct {
	Username types.String `tfsdk:"username"`
	Password types.String `tfsdk:"password"`
}

func (m *datasourceSecurityDlpFingerprintDatabaseScheduleModel) flattenSecurityDlpFingerprintDatabaseSchedule(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceSecurityDlpFingerprintDatabaseScheduleModel {
	if input == nil {
		return &datasourceSecurityDlpFingerprintDatabaseScheduleModel{}
	}
	if m == nil {
		m = &datasourceSecurityDlpFingerprintDatabaseScheduleModel{}
	}
...
func (m *datasourceSecurityDlpFingerprintDatabaseAuthenticationModel) flattenSecurityDlpFingerprintDatabaseAuthentication(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceSecurityDlpFingerprintDatabaseAuthenticationModel {
	if input == nil {
		return &datasourceSecurityDlpFingerprintDatabaseAuthenticationModel{}
	}
	if m == nil {
		m = &datasourceSecurityDlpFingerprintDatabaseAuthenticationModel{}
	}
	o := input.(map[string]interface{})

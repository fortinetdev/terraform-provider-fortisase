...
var _ datasource.DataSource = &datasourceAuthRadiusServer{}

func newDatasourceAuthRadiusServer() datasource.DataSource {
	return &datasourceAuthRadiusServer{}
}

type datasourceAuthRadiusServer struct {
...
func (r *datasourceAuthRadiusServer) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *datasourceAuthRadiusServer) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *datasourceAuthRadiusServer) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceAuthRadiusServerModel
...
func (m *datasourceAuthRadiusServerModel) refreshAuthRadiusServer(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceAuthRadiusServerModel) getURLObjectAuthRadiusServer(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

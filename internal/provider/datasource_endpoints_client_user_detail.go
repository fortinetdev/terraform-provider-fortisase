...
var _ datasource.DataSource = &datasourceEndpointsClientUserDetail{}

func newDatasourceEndpointsClientUserDetail() datasource.DataSource {
	return &datasourceEndpointsClientUserDetail{}
}

type datasourceEndpointsClientUserDetail struct {
	fortiClient  *FortiClient
	resourceName string
}

// datasourceEndpointsClientUserDetailModel describes the datasource data model.
type datasourceEndpointsClientUserDetailModel struct {
	...
	ConnDetails             []datasourceEndpointsClientUserDetailConnDetailsModel    `tfsdk:"conn_details"`
	HardwareDetails         *datasourceEndpointsClientUserDetailHardwareDetailsModel `tfsdk:"hardware_details"`
	Forensics               *datasourceEndpointsClientUserDetailForensicsModel       `tfsdk:"forensics"`
	ForensicsEnabled        types.Bool                                               `tfsdk:"forensics_enabled"`
	Tags                    []datasourceEndpointsClientUserDetailTagsModel           `tfsdk:"tags"`
	ClientUserId            types.Float64                                            `tfsdk:"client_user_id"`
}

func (r *datasourceEndpointsClientUserDetail) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_endpoints_client_user_detail"
}

func (r *datasourceEndpointsClientUserDetail) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *datasourceEndpointsClientUserDetail) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	...
	r.resourceName = "fortisase_endpoints_client_user_detail"
}

func (r *datasourceEndpointsClientUserDetail) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceEndpointsClientUserDetailModel
	...
	input_model.URLParams = *(data.getURLObjectEndpointsClientUserDetail(ctx, "read", diags))
	...
	diags.Append(data.refreshEndpointsClientUserDetail(ctx, read_output)...)
	if diags.HasError() {
		return
	}
...
func (m *datasourceEndpointsClientUserDetailModel) refreshEndpointsClientUserDetail(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
	...
	if v, ok := o["connDetails"]; ok {
		m.ConnDetails = m.flattenEndpointsClientUserDetailConnDetailsList(ctx, v, &diags)
	}

	if v, ok := o["hardwareDetails"]; ok {
		m.HardwareDetails = m.HardwareDetails.flattenEndpointsClientUserDetailHardwareDetails(ctx, v, &diags)
	}

	if v, ok := o["forensics"]; ok {
		m.Forensics = m.Forensics.flattenEndpointsClientUserDetailForensics(ctx, v, &diags)
	}
	...
	if v, ok := o["tags"]; ok {
		m.Tags = m.flattenEndpointsClientUserDetailTagsList(ctx, v, &diags)
	}

	return diags
}

func (data *datasourceEndpointsClientUserDetailModel) getURLObjectEndpointsClientUserDetail(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {
	result := make(map[string]interface{})
	if !data.ClientUserId.IsNull() && !data.ClientUserId.IsUnknown() {
...
type datasourceEndpointsClientUserDetailConnDetailsModel struct {
	...
	Connections        *datasourceEndpointsClientUserDetailConnDetailsConnectionsModel `tfsdk:"connections"`
}

type datasourceEndpointsClientUserDetailConnDetailsConnectionsModel struct {
...
type datasourceEndpointsClientUserDetailHardwareDetailsModel struct {
...
type datasourceEndpointsClientUserDetailForensicsModel struct {
...
type datasourceEndpointsClientUserDetailTagsModel struct {
	Id   types.Float64 `tfsdk:"id"`
	Name types.String  `tfsdk:"name"`
}

func (m *datasourceEndpointsClientUserDetailConnDetailsModel) flattenEndpointsClientUserDetailConnDetails(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailConnDetailsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailConnDetailsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailConnDetailsModel{}
	}
	...
	if v, ok := o["connections"]; ok {
		m.Connections = m.Connections.flattenEndpointsClientUserDetailConnDetailsConnections(ctx, v, diags)
	}

	return m
}

func (s *datasourceEndpointsClientUserDetailModel) flattenEndpointsClientUserDetailConnDetailsList(ctx context.Context, o interface{}, diags *diag.Diagnostics) []datasourceEndpointsClientUserDetailConnDetailsModel {
	if o == nil {
		return []datasourceEndpointsClientUserDetailConnDetailsModel{}
	}
	...
	values := make([]datasourceEndpointsClientUserDetailConnDetailsModel, len(l))
	for i, ele := range l {
		var m datasourceEndpointsClientUserDetailConnDetailsModel
		if i < len(s.ConnDetails) {
			m = s.ConnDetails[i]
		}
		values[i] = *m.flattenEndpointsClientUserDetailConnDetails(ctx, ele, diags)
	}

	return values
}

func (m *datasourceEndpointsClientUserDetailConnDetailsConnectionsModel) flattenEndpointsClientUserDetailConnDetailsConnections(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailConnDetailsConnectionsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailConnDetailsConnectionsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailConnDetailsConnectionsModel{}
	}
	o := input.(map[string]interface{})
...
func (m *datasourceEndpointsClientUserDetailHardwareDetailsModel) flattenEndpointsClientUserDetailHardwareDetails(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailHardwareDetailsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailHardwareDetailsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailHardwareDetailsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["model"]; ok {
...
func (m *datasourceEndpointsClientUserDetailForensicsModel) flattenEndpointsClientUserDetailForensics(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailForensicsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailForensicsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailForensicsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["guid"]; ok {
...
func (m *datasourceEndpointsClientUserDetailTagsModel) flattenEndpointsClientUserDetailTags(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailTagsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailTagsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailTagsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["id"]; ok {
...
func (s *datasourceEndpointsClientUserDetailModel) flattenEndpointsClientUserDetailTagsList(ctx context.Context, o interface{}, diags *diag.Diagnostics) []datasourceEndpointsClientUserDetailTagsModel {
	if o == nil {
		return []datasourceEndpointsClientUserDetailTagsModel{}
	}
	...
	values := make([]datasourceEndpointsClientUserDetailTagsModel, len(l))
	for i, ele := range l {
		var m datasourceEndpointsClientUserDetailTagsModel
		if i < len(s.Tags) {
			m = s.Tags[i]
		}
		values[i] = *m.flattenEndpointsClientUserDetailTags(ctx, ele, diags)
	}

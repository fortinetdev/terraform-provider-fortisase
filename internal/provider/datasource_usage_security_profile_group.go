...
var _ datasource.DataSource = &datasourceUsageSecurityProfileGroup{}

func newDatasourceUsageSecurityProfileGroup() datasource.DataSource {
	return &datasourceUsageSecurityProfileGroup{}
}
...
type datasourceUsageSecurityProfileGroupModel struct {
...
func (r *datasourceUsageSecurityProfileGroup) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_usage_security_profile_group"
}
...
func (r *datasourceUsageSecurityProfileGroup) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *datasourceUsageSecurityProfileGroup) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var data datasourceUsageSecurityProfileGroupModel
	...
	input_model.URLParams = *(data.getURLObjectUsageSecurityProfileGroup(ctx, "read", diags))
	...
	diags.Append(data.refreshUsageSecurityProfileGroup(ctx, read_output)...)
	if diags.HasError() {
		return
	}
...
func (m *datasourceUsageSecurityProfileGroupModel) refreshUsageSecurityProfileGroup(ctx context.Context, o map[string]interface{}) diag.Diagnostics {

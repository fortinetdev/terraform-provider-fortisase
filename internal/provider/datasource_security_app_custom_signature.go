...
var _ datasource.DataSource = &datasourceSecurityAppCustomSignature{}

func newDatasourceSecurityAppCustomSignature() datasource.DataSource {
	return &datasourceSecurityAppCustomSignature{}
}

type datasourceSecurityAppCustomSignature struct {
	fortiClient  *FortiClient
	resourceName string
}

// datasourceSecurityAppCustomSignatureModel describes the datasource data model.
type datasourceSecurityAppCustomSignatureModel struct {
...
func (r *datasourceSecurityAppCustomSignature) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_security_app_custom_signature"
}

func (r *datasourceSecurityAppCustomSignature) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *datasourceSecurityAppCustomSignature) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *datasourceSecurityAppCustomSignature) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceSecurityAppCustomSignatureModel
...
func (m *datasourceSecurityAppCustomSignatureModel) refreshSecurityAppCustomSignature(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceSecurityAppCustomSignatureModel) getURLObjectSecurityAppCustomSignature(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

...
type datasourceSecurityApplicationCategoriesModel struct {
...
func (r *datasourceSecurityApplicationCategories) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var data datasourceSecurityApplicationCategoriesModel
	...
	input_model.URLParams = *(data.getURLObjectSecurityApplicationCategories(ctx, "read", diags))
	...
	diags.Append(data.refreshSecurityApplicationCategories(ctx, read_output)...)
	if diags.HasError() {
		return
	}
...
func (m *datasourceSecurityApplicationCategoriesModel) refreshSecurityApplicationCategories(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceSecurityApplicationCategoriesModel) getURLObjectSecurityApplicationCategories(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

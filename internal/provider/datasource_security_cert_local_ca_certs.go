...
// datasourceSecurityCertLocalCaCertsModel describes the datasource data model.
type datasourceSecurityCertLocalCaCertsModel struct {
	Ftntid         types.Float64                                   `tfsdk:"ftntid"`
	Name           types.String                                    `tfsdk:"name"`
	PrimaryKey     types.String                                    `tfsdk:"primary_key"`
	Type           types.String                                    `tfsdk:"type"`
	Source         types.String                                    `tfsdk:"source"`
	Issuer         *datasourceSecurityCertLocalCaCertsIssuerModel  `tfsdk:"issuer"`
	ValidFrom      types.String                                    `tfsdk:"valid_from"`
	ValidTo        types.String                                    `tfsdk:"valid_to"`
	SerialNumber   types.String                                    `tfsdk:"serial_number"`
	Usages         []datasourceSecurityCertLocalCaCertsUsagesModel `tfsdk:"usages"`
...
func (r *datasourceSecurityCertLocalCaCerts) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceSecurityCertLocalCaCertsModel
...
func (m *datasourceSecurityCertLocalCaCertsModel) refreshSecurityCertLocalCaCerts(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceSecurityCertLocalCaCertsModel) getURLObjectSecurityCertLocalCaCerts(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {
...
type datasourceSecurityCertLocalCaCertsIssuerModel struct {
...
type datasourceSecurityCertLocalCaCertsUsagesModel struct {
	Type  types.String  `tfsdk:"type"`
	Count types.Float64 `tfsdk:"count"`
}

func (m *datasourceSecurityCertLocalCaCertsIssuerModel) flattenSecurityCertLocalCaCertsIssuer(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceSecurityCertLocalCaCertsIssuerModel {
	if input == nil {
		return &datasourceSecurityCertLocalCaCertsIssuerModel{}
	}
	if m == nil {
		m = &datasourceSecurityCertLocalCaCertsIssuerModel{}
	}
...
func (m *datasourceSecurityCertLocalCaCertsUsagesModel) flattenSecurityCertLocalCaCertsUsages(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceSecurityCertLocalCaCertsUsagesModel {
	if input == nil {
		return &datasourceSecurityCertLocalCaCertsUsagesModel{}
	}
	if m == nil {
		m = &datasourceSecurityCertLocalCaCertsUsagesModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["type"]; ok {
		m.Type = parseStringValue(v)
...
func (s *datasourceSecurityCertLocalCaCertsModel) flattenSecurityCertLocalCaCertsUsagesList(ctx context.Context, o interface{}, diags *diag.Diagnostics) []datasourceSecurityCertLocalCaCertsUsagesModel {
	if o == nil {
		return []datasourceSecurityCertLocalCaCertsUsagesModel{}
	}
	...
	values := make([]datasourceSecurityCertLocalCaCertsUsagesModel, len(l))
	for i, ele := range l {
		var m datasourceSecurityCertLocalCaCertsUsagesModel

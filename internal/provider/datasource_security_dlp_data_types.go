...
// datasourceSecurityDlpDataTypesModel describes the datasource data model.
type datasourceSecurityDlpDataTypesModel struct {
...
func (r *datasourceSecurityDlpDataTypes) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	...
	r.resourceName = "fortisase_security_dlp_data_types"
}

func (r *datasourceSecurityDlpDataTypes) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceSecurityDlpDataTypesModel
	...
	input_model.URLParams = *(data.getURLObjectSecurityDlpDataTypes(ctx, "read", diags))
	...
	diags.Append(data.refreshSecurityDlpDataTypes(ctx, read_output)...)
	if diags.HasError() {
		return
	}
...
func (m *datasourceSecurityDlpDataTypesModel) refreshSecurityDlpDataTypes(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceSecurityDlpDataTypesModel) getURLObjectSecurityDlpDataTypes(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

...
type datasourceSecurityAntivirusFiletypesModel struct {
...
func (r *datasourceSecurityAntivirusFiletypes) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var data datasourceSecurityAntivirusFiletypesModel
	...
	input_model.URLParams = *(data.getURLObjectSecurityAntivirusFiletypes(ctx, "read", diags))
	...
	diags.Append(data.refreshSecurityAntivirusFiletypes(ctx, read_output)...)
	if diags.HasError() {
		return
	}
...
func (m *datasourceSecurityAntivirusFiletypesModel) refreshSecurityAntivirusFiletypes(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceSecurityAntivirusFiletypesModel) getURLObjectSecurityAntivirusFiletypes(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

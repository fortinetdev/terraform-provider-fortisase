...
var _ datasource.DataSource = &datasourceEndpointsDetail{}

func newDatasourceEndpointsDetail() datasource.DataSource {
	return &datasourceEndpointsDetail{}
}

type datasourceEndpointsDetail struct {
	fortiClient  *FortiClient
	resourceName string
}

// datasourceEndpointsDetailModel describes the datasource data model.
type datasourceEndpointsDetailModel struct {
	...
	ConnDetails             []datasourceEndpointsDetailConnDetailsModel    `tfsdk:"conn_details"`
	HardwareDetails         *datasourceEndpointsDetailHardwareDetailsModel `tfsdk:"hardware_details"`
	Forensics               *datasourceEndpointsDetailForensicsModel       `tfsdk:"forensics"`
	ForensicsEnabled        types.Bool                                     `tfsdk:"forensics_enabled"`
	Tags                    []datasourceEndpointsDetailTagsModel           `tfsdk:"tags"`
}

func (r *datasourceEndpointsDetail) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_endpoints_detail"
}

func (r *datasourceEndpointsDetail) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *datasourceEndpointsDetail) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	...
	r.resourceName = "fortisase_endpoints_detail"
}

func (r *datasourceEndpointsDetail) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceEndpointsDetailModel
	...
	input_model.URLParams = *(data.getURLObjectEndpointsDetail(ctx, "read", diags))
	...
	diags.Append(data.refreshEndpointsDetail(ctx, read_output)...)
	if diags.HasError() {
		return
	}
...
func (m *datasourceEndpointsDetailModel) refreshEndpointsDetail(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
	...
	if v, ok := o["connDetails"]; ok {
		m.ConnDetails = m.flattenEndpointsDetailConnDetailsList(ctx, v, &diags)
	}

	if v, ok := o["hardwareDetails"]; ok {
		m.HardwareDetails = m.HardwareDetails.flattenEndpointsDetailHardwareDetails(ctx, v, &diags)
	}

	if v, ok := o["forensics"]; ok {
		m.Forensics = m.Forensics.flattenEndpointsDetailForensics(ctx, v, &diags)
	}
	...
	if v, ok := o["tags"]; ok {
		m.Tags = m.flattenEndpointsDetailTagsList(ctx, v, &diags)
	}

	return diags
}

func (data *datasourceEndpointsDetailModel) getURLObjectEndpointsDetail(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {
...
type datasourceEndpointsDetailConnDetailsModel struct {
	...
	Connections        *datasourceEndpointsDetailConnDetailsConnectionsModel `tfsdk:"connections"`
}

type datasourceEndpointsDetailConnDetailsConnectionsModel struct {
...
type datasourceEndpointsDetailHardwareDetailsModel struct {
...
type datasourceEndpointsDetailForensicsModel struct {
...
type datasourceEndpointsDetailTagsModel struct {
	Id   types.Float64 `tfsdk:"id"`
	Name types.String  `tfsdk:"name"`
}

func (m *datasourceEndpointsDetailConnDetailsModel) flattenEndpointsDetailConnDetails(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsDetailConnDetailsModel {
	if input == nil {
		return &datasourceEndpointsDetailConnDetailsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsDetailConnDetailsModel{}
	}
	...
	if v, ok := o["connections"]; ok {
		m.Connections = m.Connections.flattenEndpointsDetailConnDetailsConnections(ctx, v, diags)
	}

	return m
}

func (s *datasourceEndpointsDetailModel) flattenEndpointsDetailConnDetailsList(ctx context.Context, o interface{}, diags *diag.Diagnostics) []datasourceEndpointsDetailConnDetailsModel {
	if o == nil {
		return []datasourceEndpointsDetailConnDetailsModel{}
	}
	...
	values := make([]datasourceEndpointsDetailConnDetailsModel, len(l))
	for i, ele := range l {
		var m datasourceEndpointsDetailConnDetailsModel
		if i < len(s.ConnDetails) {
			m = s.ConnDetails[i]
		}
		values[i] = *m.flattenEndpointsDetailConnDetails(ctx, ele, diags)
	}

	return values
}

func (m *datasourceEndpointsDetailConnDetailsConnectionsModel) flattenEndpointsDetailConnDetailsConnections(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsDetailConnDetailsConnectionsModel {
	if input == nil {
		return &datasourceEndpointsDetailConnDetailsConnectionsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsDetailConnDetailsConnectionsModel{}
	}
	o := input.(map[string]interface{})
...
func (m *datasourceEndpointsDetailHardwareDetailsModel) flattenEndpointsDetailHardwareDetails(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsDetailHardwareDetailsModel {
	if input == nil {
		return &datasourceEndpointsDetailHardwareDetailsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsDetailHardwareDetailsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["model"]; ok {
...
func (m *datasourceEndpointsDetailForensicsModel) flattenEndpointsDetailForensics(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsDetailForensicsModel {
	if input == nil {
		return &datasourceEndpointsDetailForensicsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsDetailForensicsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["guid"]; ok {
...
func (m *datasourceEndpointsDetailTagsModel) flattenEndpointsDetailTags(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsDetailTagsModel {
	if input == nil {
		return &datasourceEndpointsDetailTagsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsDetailTagsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["id"]; ok {
...
func (s *datasourceEndpointsDetailModel) flattenEndpointsDetailTagsList(ctx context.Context, o interface{}, diags *diag.Diagnostics) []datasourceEndpointsDetailTagsModel {
	if o == nil {
		return []datasourceEndpointsDetailTagsModel{}
	}
	...
	values := make([]datasourceEndpointsDetailTagsModel, len(l))
	for i, ele := range l {
		var m datasourceEndpointsDetailTagsModel
		if i < len(s.Tags) {
			m = s.Tags[i]
		}
		values[i] = *m.flattenEndpointsDetailTags(ctx, ele, diags)
	}

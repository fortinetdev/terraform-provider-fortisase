...
type datasourceEndpointsClientUserDetailsModel struct {
	...
	ConnDetails             []datasourceEndpointsClientUserDetailsConnDetailsModel    `tfsdk:"conn_details"`
	HardwareDetails         *datasourceEndpointsClientUserDetailsHardwareDetailsModel `tfsdk:"hardware_details"`
	Forensics               *datasourceEndpointsClientUserDetailsForensicsModel       `tfsdk:"forensics"`
	ForensicsEnabled        types.Bool                                                `tfsdk:"forensics_enabled"`
	Tags                    []datasourceEndpointsClientUserDetailsTagsModel           `tfsdk:"tags"`
...
func (r *datasourceEndpointsClientUserDetails) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var data datasourceEndpointsClientUserDetailsModel
	...
	input_model.URLParams = *(data.getURLObjectEndpointsClientUserDetails(ctx, "read", diags))
	...
	diags.Append(data.refreshEndpointsClientUserDetails(ctx, read_output)...)
	if diags.HasError() {
		return
	}
...
func (m *datasourceEndpointsClientUserDetailsModel) refreshEndpointsClientUserDetails(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
	...
	if v, ok := o["connDetails"]; ok {
		m.ConnDetails = m.flattenEndpointsClientUserDetailsConnDetailsList(ctx, v, &diags)
	}

	if v, ok := o["hardwareDetails"]; ok {
		m.HardwareDetails = m.HardwareDetails.flattenEndpointsClientUserDetailsHardwareDetails(ctx, v, &diags)
	}

	if v, ok := o["forensics"]; ok {
		m.Forensics = m.Forensics.flattenEndpointsClientUserDetailsForensics(ctx, v, &diags)
	}
	...
	if v, ok := o["tags"]; ok {
		m.Tags = m.flattenEndpointsClientUserDetailsTagsList(ctx, v, &diags)
	}

	return diags
}

func (data *datasourceEndpointsClientUserDetailsModel) getURLObjectEndpointsClientUserDetails(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {
...
type datasourceEndpointsClientUserDetailsConnDetailsModel struct {
	...
	Connections        *datasourceEndpointsClientUserDetailsConnDetailsConnectionsModel `tfsdk:"connections"`
}

type datasourceEndpointsClientUserDetailsConnDetailsConnectionsModel struct {
...
type datasourceEndpointsClientUserDetailsHardwareDetailsModel struct {
...
type datasourceEndpointsClientUserDetailsForensicsModel struct {
...
type datasourceEndpointsClientUserDetailsTagsModel struct {
	Id   types.Float64 `tfsdk:"id"`
	Name types.String  `tfsdk:"name"`
}

func (m *datasourceEndpointsClientUserDetailsConnDetailsModel) flattenEndpointsClientUserDetailsConnDetails(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailsConnDetailsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailsConnDetailsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailsConnDetailsModel{}
	}
	...
	if v, ok := o["connections"]; ok {
		m.Connections = m.Connections.flattenEndpointsClientUserDetailsConnDetailsConnections(ctx, v, diags)
	}

	return m
}

func (s *datasourceEndpointsClientUserDetailsModel) flattenEndpointsClientUserDetailsConnDetailsList(ctx context.Context, o interface{}, diags *diag.Diagnostics) []datasourceEndpointsClientUserDetailsConnDetailsModel {
	if o == nil {
		return []datasourceEndpointsClientUserDetailsConnDetailsModel{}
	}
	...
	values := make([]datasourceEndpointsClientUserDetailsConnDetailsModel, len(l))
	for i, ele := range l {
		var m datasourceEndpointsClientUserDetailsConnDetailsModel
		values[i] = *m.flattenEndpointsClientUserDetailsConnDetails(ctx, ele, diags)
	}

	return values
}

func (m *datasourceEndpointsClientUserDetailsConnDetailsConnectionsModel) flattenEndpointsClientUserDetailsConnDetailsConnections(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailsConnDetailsConnectionsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailsConnDetailsConnectionsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailsConnDetailsConnectionsModel{}
	}
	o := input.(map[string]interface{})
...
func (m *datasourceEndpointsClientUserDetailsHardwareDetailsModel) flattenEndpointsClientUserDetailsHardwareDetails(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailsHardwareDetailsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailsHardwareDetailsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailsHardwareDetailsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["model"]; ok {
...
func (m *datasourceEndpointsClientUserDetailsForensicsModel) flattenEndpointsClientUserDetailsForensics(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailsForensicsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailsForensicsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailsForensicsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["guid"]; ok {
...
func (m *datasourceEndpointsClientUserDetailsTagsModel) flattenEndpointsClientUserDetailsTags(ctx context.Context, input interface{}, diags *diag.Diagnostics) *datasourceEndpointsClientUserDetailsTagsModel {
	if input == nil {
		return &datasourceEndpointsClientUserDetailsTagsModel{}
	}
	if m == nil {
		m = &datasourceEndpointsClientUserDetailsTagsModel{}
	}
	o := input.(map[string]interface{})
	if v, ok := o["id"]; ok {
...
func (s *datasourceEndpointsClientUserDetailsModel) flattenEndpointsClientUserDetailsTagsList(ctx context.Context, o interface{}, diags *diag.Diagnostics) []datasourceEndpointsClientUserDetailsTagsModel {
	if o == nil {
		return []datasourceEndpointsClientUserDetailsTagsModel{}
	}
	...
	values := make([]datasourceEndpointsClientUserDetailsTagsModel, len(l))
	for i, ele := range l {
		var m datasourceEndpointsClientUserDetailsTagsModel
		values[i] = *m.flattenEndpointsClientUserDetailsTags(ctx, ele, diags)
	}

...
var _ datasource.DataSource = &datasourceAuthFssoAgent{}

func newDatasourceAuthFssoAgent() datasource.DataSource {
	return &datasourceAuthFssoAgent{}
}

type datasourceAuthFssoAgent struct {
	fortiClient  *FortiClient
	resourceName string
}

// datasourceAuthFssoAgentModel describes the datasource data model.
type datasourceAuthFssoAgentModel struct {
...
func (r *datasourceAuthFssoAgent) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_auth_fsso_agent"
}

func (r *datasourceAuthFssoAgent) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *datasourceAuthFssoAgent) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *datasourceAuthFssoAgent) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	diags := &resp.Diagnostics
	var data datasourceAuthFssoAgentModel
...
func (m *datasourceAuthFssoAgentModel) refreshAuthFssoAgent(ctx context.Context, o map[string]interface{}) diag.Diagnostics {
...
func (data *datasourceAuthFssoAgentModel) getURLObjectAuthFssoAgent(ctx context.Context, ope string, diags *diag.Diagnostics) *map[string]interface{} {

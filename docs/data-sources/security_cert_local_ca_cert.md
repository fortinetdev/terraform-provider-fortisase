...
page_title: "fortisase_security_cert_local_ca_cert Data Source - fortisase"
subcategory: "Security"
description: |-
  Certificate Resource API for FortiSASE
---

# fortisase_security_cert_local_ca_cert (Data Source)
...
```terraform
data "fortisase_security_cert_local_ca_cert" "example" {

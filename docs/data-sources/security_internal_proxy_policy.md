...
page_title: "fortisase_security_internal_proxy_policy Data Source - fortisase"
subcategory: "Security"
description: |-
  Internal Proxy Policy Resource API V2 for FortiSASE.
---

# fortisase_security_internal_proxy_policy (Data Source)
...
```terraform
data "fortisase_security_internal_proxy_policy" "example" {

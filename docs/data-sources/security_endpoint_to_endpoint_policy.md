...
page_title: "fortisase_security_endpoint_to_endpoint_policy Data Source - fortisase"
subcategory: "Security"
description: |-
  Endpoint to Endpoint Policy Resource API V2 for FortiSASE.
---

# fortisase_security_endpoint_to_endpoint_policy (Data Source)
...
```terraform
data "fortisase_security_endpoint_to_endpoint_policy" "example" {

...
page_title: "fortisase_security_outbound_policy Resource - fortisase"
subcategory: "Security"
description: |-
  Outbound Policy Resource API V2 for FortiSASE.
---

# fortisase_security_outbound_policy (Resource)
...
```shell
terraform import fortisase_security_outbound_policy.{{your_resource_name}} {{primary_key}}
```
